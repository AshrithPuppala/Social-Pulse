    ...
    if is_configured:
        status_html = '''
            <div class="info-box">
                ...
                <span class="credibility-badge">✓ Credible Sources Only</span>
            </div>
            <div class="filter-info">
                🛡️ <strong>Quality Filtering Active:</strong> Only articles from established, credible news sources are analyzed to ensure accuracy and reliability.
            </div>
        '''
    else:
        status_html = '''
